...
class QuestionDraft:
    ...
    def is_complete(self) -> bool:
        """檢查題目是否完整"""
        return bool(self.question_text and len(self.options) >= 2 and self.correct_answer)
...
class ExamGenerator:
    ...
    def generate(
        ...
        prompt = self._build_prompt(
            num_questions, question_type, difficulty, topics, source_doc, additional_instructions
        )
